...
filename_prefix = '_'.join(['liosam', sensor_type,'for', sequence_name, 'img10hz600p'])
...
shutil.copy(os.path.join('../../config', 'BotanicGarden_params.yaml'), os.path.join(sequence_name, filename_prefix, current_testfolder_name, 'config', 'BotanicGarden_params.yaml'))
